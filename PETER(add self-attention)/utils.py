...
class DataLoader:
    def __init__(self, data_path, index_dir, vocab_size, args):
        ...
        self.reviews = self.prep_profile_data_list(smax=self.args.words, dmax=self.args.profile_len, data_path = args.data_path)
    ...
    def load_data(self, dir, data_path, index_dir):
        data = []
