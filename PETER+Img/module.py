...
class PETER(nn.Module):
    ...
    def forward(self, user, item, text, image_feature, seq_prediction=True, context_prediction=True, rating_prediction=True):
        '''
        ...
        return log_word_prob, log_context_dis, rating, attns, img_fea_p
